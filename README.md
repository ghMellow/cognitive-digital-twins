...
The project is organized into two specialized repositories:

### 1. [Theory & Manuscript](https://github.com/ghMellow/cognitive-digital-twins-thesis)
Contains the theoretical foundations, architectural diagrams, bibliography, and the LaTeX source for the thesis manuscript.
